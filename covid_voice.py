...
API_KEY = "tBTmfb0KYACx"
PROJECT_TOKEN = "tz5OTdBhKFTt"
RUN_TOKEN = "twgzguvhSO7D"
...
class Data:
    ...
    def update_data(self):
        response = requests.post(f'https://www.parsehub.com/api/v2/projects/{self.project_token}/run', params = {"api_key": self.api_key})
...
def main():
    ...
    while True:
        ...
        if text == UPDATE_COMMAND:
            result = "Data is being updated. This may take a few moments!"
            data.update_data()
        if result:
            speak(result)
